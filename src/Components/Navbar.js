...
const Navbar = (props) => {
    ...
    return (
        <div className='flex justify-between items-center w-11/12 max-w-[1160px] h-full py-4 mx-auto bg-richblack-900'>
            
                <Link to='/'>
                    <img src={Logo} alt="Logo" width={150} height={30} loading="lazy"/>
                </Link>
                <nav>
                    <ul className='text-richblack-100 text-[0.8rem] flex gap-x-6'>
                        <li>
                            <Link to='/'>Home</Link>
                        </li>
                        <li>
                ...
                <div className='flex items-center gap-x-4'>
                    { !isLoggedIn &&
                        <Link to='/login'>
                            <button className='bg-richblack-800 text-[0.8rem] text-richblack-100 py-[8px] px-[12px] rounded-[8px] 
